...
class Constants :
	...
	def setConstant(self, inPath):
		...
		self.OUTPUT_CLASS_WRD_TOTAL		= self.OUT_DIR / 'outputClassDefinitionTotal.doc'
		self.OUTPUT_INTERFACE_WRD_TOTAL		= self.OUT_DIR / 'outputInterfaceDefinitionTotal.doc'
		#-----------------------------------------------------------------------
