...
from Products.model_2.config import PROJECTNAME
from Products.model_2.config import product_globals as GLOBALS

def install(self):
    """ External Method to install model_2 """
    out = StringIO()
    ...
    try:
        from Products.model_2.config import DEPENDENCIES
    except:
        DEPENDENCIES = []
    ...
    from Products.model_2.config import STYLESHEETS
    try:
        ...
        pass
    from Products.model_2.config import JAVASCRIPTS
    try:
