...
def fromParameterToString(p):
    '''fromParameterToString returns the textual representation of a parameter according to the specification.
...
def fromOrderingToString(ae):
    """fromOrderingToString gets the orderingkind from an associationEnd so that it will be easier to print relevant output to the screen..."""
    s=""
...
def fromVisibilityToString(ae):
    """fromVisibilityToString takes an AssociationEnd Rolename as the argument and returns the given visibility of the name e.g +specification=public..."""
    s=""
