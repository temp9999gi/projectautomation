...
##		self.DAO_OUT_DIR 	= self.OUT_DIR / 'dao' / 'ibatis'
		...
		#Mgr
		self.MGR_TEMPLATE 	= self.TEMPLATE_DIR / "MGR_TEMPLATE.tmpl"
		self.MGR_OUT_DIR 	= self.OUT_DIR / 'mgr'

		
		
		#Dao
		self.DAO_TEMPLATE 	= self.TEMPLATE_DIR / "DAO_TEMPLATE.tmpl"
		self.DAO_OUT_DIR 	= self.OUT_DIR / 'dao'
		
		#-----------------------------------------------------------------------
		#ACTIVITY_CLASS
		self.ACTIVITY_CLASS_TEMPLATE 	= self.TEMPLATE_DIR / "ACTIVITY_CLASS_TEMPLATE.tmpl"
		self.ACTIVITY_CLASS_OUT_DIR 	= self.OUT_DIR / 'activity'


		#SERVICE_XML
		self.SERVICE_XML_TEMPLATE 	= self.TEMPLATE_DIR / "SERVICE_XML_TEMPLATE.tmpl"
		self.SERVICE_XML_OUT_DIR 	= self.OUT_DIR / 'service'

		#QUERY_XML
		self.QUERY_XML_TEMPLATE 	= self.TEMPLATE_DIR / "QUERY_XML_TEMPLATE.tmpl"
		self.QUERY_XML_OUT_DIR 	= self.OUT_DIR / 'query'
