...
if __name__ == "__main__":
	...
	suite.addTest(DaoTestCase("testImportArea"))
	suite.addTest(DaoTestCase("testMethodCheck"))
	suite.addTest(DaoTestCase("testUpdateMethod"))
	suite.addTest(DaoTestCase("testDeleteMethod"))
